...
const userDataGenerator = function(type, amountOfUsers, amountOfDays, difficulty){
  const users = {};
  const deviceTypes = {
    up: {
  ...
  for(var i = 0; i < amountOfUsers; i++){
    ...
    // create a object at user id with, device type, data, weight, height name (use name generator library)
